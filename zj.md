...
* [Windows PowerShell Cookbook 3rd Edition例程](https://resources.oreilly.com/examples/0636920024132)
...
# 网器
* [在线解释器](https://repl.it/languages)
* [C# 交互解释器](https://github.com/dotnet/roslyn/wiki/Interactive-Window#repl)
* [Clink - Powerful Bash-style command line editing for cmd.exe](https://mridgers.github.io/clink/)
* [Portable console emulator for Windows](https://cmder.net/)
* [ConEmu](https://conemu.github.io/)
* [Console](https://sourceforge.net/projects/console/)

# 网络管理
* [OpenNMS](https://www.opennms.org/en/opennms)
...
* [Windows Server 2012 Self-Study Guide (The Fundamentals)](https://blogs.technet.microsoft.com/musings_of_a_technical_tam/2013/04/06/windows-server-2012-self-study-guide-the-fundamentals/)
* [CS 476/576- Systems Programming](https://www.cs.odu.edu/~advisor/advising/syllabi_old/cs476f04w.htm)
...
* [The Win32 Programming Tutorials For Fun](https://www.installsetupconfig.com/win32programming/index.html)

# 教档荟萃
* [Nicome](https://gerardnico.com/start)

# 杂记
* [How do I debug a powershell module in Visual Studio](https://stackoverflow.com/questions/35298963/how-do-i-debug-a-powershell-module-in-visual-studio)
* [30 Bash Script Examples](https://linuxhint.com/30_bash_script_examples/)
* [Batch Files: Examples](https://www.robvanderwoude.com/batexamples.php)
* [34 Useful Keyboard Shortcuts for the Windows Command Prompt](https://www.howtogeek.com/254401/34-useful-keyboard-shortcuts-for-the-windows-command-prompt/)
...
* [Perl Net::SNMP](https://metacpan.org/pod/Net::SNMP)
* [Perl Using the SNMP module from the Net-SNMP library](https://www.perlmonks.org/?node_id=396223)
* [Install and Configure SNMP on Ubuntu 18.04 and CentOS 7](https://kifarunix.com/install-and-configure-snmp-ubuntu-18-04-and-centos-7/)
* [How to Install and Configure Cacti on Ubuntu 18.04](https://computingforgeeks.com/how-to-install-and-configure-cacti-on-ubuntu-18-04/)

* [How to parse binary data with Perl?](https://www.perl.com/article/how-to-parse-binary-data-with-perl/)
* [Perl Pack/Unpack Tutorial](https://www.perlmonks.org/?node_id=224666)
* [perlpacktut](https://perldoc.perl.org/perlpacktut.html)
